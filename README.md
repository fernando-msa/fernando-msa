...
1. 🔐 [**SecPolicy HAMA**](https://github.com/fernando-msa/secpolicy-hama) — gestão de conformidade baseada em ISO 27001
2. 📱 [**MOB App (PWA)**](https://github.com/fernando-msa/mob-app) — aplicação com autenticação, RLS e foco em uso real
3. 🌎 [**Tradutor MSA (Extensão)**](https://github.com/fernando-msa/Tradutor-MSA-Extensao) — produtividade com voz, leitura e histórico
...
- Repositórios: https://github.com/fernando-msa?tab=repositories
- Projetos pinados: https://github.com/fernando-msa
